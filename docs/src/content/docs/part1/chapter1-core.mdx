...
**See [Appendix A: Elliptic Curve Taxonomy](/appendix/elliptic-curves)** for a comprehensive guide covering:
...
**For minichain:** We keep them as placeholders for now. A truly minimal PoA chain could remove both — we may do so once we finalize the consensus design in [Chapter 5](/part5/chapter5-chain).
