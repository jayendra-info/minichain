...
| Signing | Ed25519 | Fast, compact signatures ([`ed25519-dalek` crate](https://github.com/dalek-cryptography/curve25519-dalek), [comparison](/part1/chapter1-core#why-ed25519-over-secp256k1)) |
...
Let's start building! Head to [Chapter 1: Core Primitives](/part1/chapter1-core) to implement the foundation.
