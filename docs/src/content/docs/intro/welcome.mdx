...
Ready to dive in? Start with the [Project Overview](/intro/overview) to understand the architecture, then jump into [Chapter 1: Core Primitives](/part1/chapter1-core).
