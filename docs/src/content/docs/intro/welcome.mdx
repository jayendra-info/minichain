...
<CardGrid>
  ...
  <a href="/minichain/part5/chapter5-chain" class="card-link">
    <Card title="Consensus" icon="approve-check">
      Proof of Authority (PoA) consensus for block validation
    </Card>
  </a>
  <a href="/minichain/part6/chapter6-cli" class="card-link">
...
You can also explore the full contract example at [English Auction Smart Contract](/minichain/appendix/auction-contract).
