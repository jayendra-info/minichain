...
<Aside type="tip">
**Looking for advanced topics?** After completing this chapter, see [Appendix B: Advanced Blockchain Concepts](/appendix/advanced-blockchain) for block reorganization, transaction receipts, and light clients.
</Aside>
...
This chapter covered the core blockchain implementation. For production-grade features that extend beyond Minichain's scope, see [Appendix B: Advanced Blockchain Concepts](/appendix/advanced-blockchain), which covers:
