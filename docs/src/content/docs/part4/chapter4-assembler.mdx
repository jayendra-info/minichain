...
For comprehensive documentation including all instructions, syntax, effects, gas costs, and examples, see [Appendix C: Complete Instruction Set Reference](/appendix/instruction-set).

For VM implementation details, see [Chapter 3, Section 3.3](/part3/chapter3-vm#33-opcode-definitions).
</Aside>
...
<Aside type="tip">
**For detailed instruction documentation** including all syntax variations, gas costs, usage examples, and gotchas, see [Appendix C: Complete Instruction Set Reference](/appendix/instruction-set).
</Aside>
