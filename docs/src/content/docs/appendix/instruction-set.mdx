...
- VM implementation: See [Chapter 3: Register-Based VM](/part3/chapter3-vm)
- Assembler implementation: See [Chapter 4: Assembly to Bytecode](/part4/chapter4-assembler)
</Aside>
...
<Aside type="note">
**LOG** is primarily for debugging during development. In production smart contracts, you'd typically use event logs (stored in transaction receipts) instead. See [Appendix B: Advanced Blockchain Concepts](/appendix/advanced-blockchain#b2-transaction-receipts) for event log implementation.
</Aside>
...
- [Chapter 3: Register-Based VM](/part3/chapter3-vm) - VM implementation
- [Chapter 4: Assembly to Bytecode](/part4/chapter4-assembler) - Assembler implementation
