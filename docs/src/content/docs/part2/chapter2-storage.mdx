...
```mermaid
graph LR
    subgraph Initial[Initial State<br/>State Root: 0x7d3f...]
        IA[Alice<br/>bal=1000]
        IB[Bob<br/>bal=500]
    end
    
    subgraph Final[After Transfer<br/>State Root: 0x9e2a...]
        FA[Alice<br/>bal=900<br/>−100]
        FB[Bob<br/>bal=600<br/>+100]
    end
