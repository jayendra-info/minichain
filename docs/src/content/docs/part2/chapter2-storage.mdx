...
In blockchain, every address *implicitly* exists with zero balance and zero nonce. You can send Mini Tokens to any address — it doesn't need to be "created" first.
...
Let's trace what happens when Alice sends 100 Mini Tokens to Bob:
