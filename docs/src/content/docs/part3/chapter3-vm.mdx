...
For the full instruction set with syntax, gas costs, and examples, see [Appendix C: Complete Instruction Set Reference](/appendix/instruction-set).

This section focuses on the VM implementation. For assembly programming usage, see [Chapter 4, Section 4.2](/part4/chapter4-assembler).
</Aside>
