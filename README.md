...
```bash
# Mint Mini Coins so Alice can pay deployment and call gas
...
| `account mint` | Mint Mini Coins (authority only) | `minichain account mint --from @authority_0 --to 0xABC... --amount 50000` |
